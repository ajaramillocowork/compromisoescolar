            ...
            <div class="card_c" style="" id="fondo_izq">
                <table align="center" width="100%" cellspacing="10">
                    <tr align="left" valign="top"  width="100%">
                        <h2 id="c_tit">
                            <strong>Encuesta:</strong> Te invitamos a superar las nueve etapas
                            <hr id="tit">
                        </h2>
                    </tr>
                    <tr align="left" valign="top"  width="100%">
