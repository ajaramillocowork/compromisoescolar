                            ...
                            <div class="col-xs-12">
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <span>
                                                <p style="font-size: 20px; text-align: center">Reporte de establecimiento Básica <i class="fa fa-question-circle" style="color:#2d6693; font-size: 20px" aria-hidden="true" onclick="definicion_cuadrantes()"></i></p>
                                            </span>
                                        </div>
